...
const ManageSavedAddressesScreen = ({ navigation }) => {
  ...
  const handleEditAddress = (address) => {
    navigation.navigate('LocationPickerScreen', {
      ...
      returnScreen: 'ManageSavedAddressesScreen',
    });
  };
  ...
  return (
    <SafeAreaView style={styles.safeAreaBlack}>
      ...
      <View style={styles.container}>
        <CommonAppBar title="Manage Addresses" navigation={navigation} />
...
export default ManageSavedAddressesScreen;
